    ...
    <Wrapper>
      <Spacing>
        <Button text={'+ Nuevo estudiante'}
                theme={{ color: Colors.white, bg: Colors.success, borderColor: Colors.transparent }}/>
      </Spacing>
      <Table>
        <Thead/>
        <tbody>
      ...
      {selectUser && <UserInfo user={selectUser} users={props.users} setSelectedUser={setSelectedUser}/>}
    </Wrapper>
  );
};
